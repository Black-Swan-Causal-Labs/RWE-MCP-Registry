...
- [`rwe-mcp-verified-capability-cards.xlsx`](public-data/rwe-mcp-verified-capability-cards.xlsx) — 132 reviewed capability cards covering study design, evidence synthesis, clinical interoperability, OMOP/terminology, pharmacovigilance, regulatory data, public health, and RWE infrastructure. The September 6, 2026 additions include DAG Studio WebMCP and Study Design Diagram Studio WebMCP, both listed in the official MCP Registry.

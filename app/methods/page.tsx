...
export default function MethodsPage() {
  ...
  return <main className="methods-page">
    ...
    <section className="methods-hero">
      ...
      <div className="methods-intro"><p>A living search protocol and a record of completed discovery and review work for real-world evidence tooling.</p><p>Updated {completionCount.asOf} · {(176 + completionCount.entries).toLocaleString()} active cards · Static source review with documented coverage limits.</p></div>
    </section>
    ...
    <section className="protocol" id="protocol">
      ...
      <aside className="verification-protocol" id="verification">
        ...
        <div>
          ...
          <dl><div><dt>{(176 + completionCount.entries).toLocaleString()}</dt><dd>active capability cards after this continuation</dd></div><div><dt>{completionCount.entries.toLocaleString()}</dt><dd>new reviewed cards</dd></div><div><dt>1</dt><dd>historical card held after source correction</dd></div><div><dt>0</dt><dd>candidate projects runtime-tested</dd></div></dl>
    ...
    <section className="decision-rules" id="latest-pass">
      ...
      <div>
        ...
        <h3>Download the registry</h3><p><a href={`${basePath}/public-data/rwe-mcp-verified-capability-cards.xlsx`}>Reviewed capability workbook ↗</a> · <a href={`${basePath}/data/reviewed-search-completion-2026-09-07.json`}>New capability cards as JSON ↗</a></p>

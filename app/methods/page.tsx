...
export default function MethodsPage() {
  ...
  return <main className="methods-page">
    ...
    <section className="methods-hero">
      ...
      <div className="methods-intro"><p>A living, reproducible protocol for finding MCP servers, connectors, skills, libraries, and agents relevant to real-world evidence.</p><p>Last updated August 11, 2026 · Catalogue and known-inventory sweep completed.</p></div>
    </section>

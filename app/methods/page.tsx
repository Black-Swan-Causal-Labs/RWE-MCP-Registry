...
export default function MethodsPage() {
  ...
  return <main className="methods-page">
    ...
    <section className="decision-rules" id="relevance">
      ...
      <div><p>The September expansion published 6,227 cards using an overly broad interpretation of enabling infrastructure. A later relevance audit separates the core catalogue from adjacent discoveries and unresolved component questions. The website displays only the core catalogue. Archive and borderline records remain in the downloadable Excel workbook, with all existing IDs and source history preserved.</p>
